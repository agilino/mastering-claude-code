...
urls="$(grep -rhoE 'https?://[A-Za-z0-9./_#?=&%+~:@-]+' README.md FACILITATOR.md docs tasks slides/sections slides/BRAND.md slides/scripts/generate-qr.mjs workshop-artifacts 2>/dev/null \
