...
1. Pick one brief from `workshop-artifacts/14-capstone/README.md` in the workshop repository.
   - **A** Clash comments.
...
Use the checklist at the end of `workshop-artifacts/14-capstone/README.md`. Every box.

## Stuck?

`git checkout 14-start` — the reference CLASH with `CLAUDE.md`, the skill, the fix and the hook set.
