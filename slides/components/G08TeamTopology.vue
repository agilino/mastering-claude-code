...
<template>
  <svg viewBox="0 20 960 420" width="960" height="420" class="w-full max-w-4xl h-auto max-h-full" font-family="Inter, sans-serif">
    <defs>
    ...
    <g v-click>
      ...
      <line :x1="580" :y1="peerY - 32" :x2="leadX + 20" :y2="leadY + 32"
        stroke="var(--na-accent-500)" stroke-width="3" marker-end="url(#arrow-accent)" />
      <!-- left callout: right-aligned, left of the venues→lead path -->
      <text x="332" y="272" text-anchor="end" fill="var(--na-accent-500)" font-family="'JetBrains Mono', monospace" style="font-size:13px">SendMessage(lead):</text>
      <text x="332" y="292" text-anchor="end" fill="var(--na-fg)" style="font-size:13px">"venue delete looks safe"</text>
      <!-- right callout: left-aligned, right of the participations→lead path -->
      <text x="612" y="272" fill="var(--na-accent-500)" font-family="'JetBrains Mono', monospace" style="font-size:13px">SendMessage(lead):</text>
      <text x="612" y="292" fill="var(--na-fg)" style="font-size:13px">"venue delete is missing a check"</text>
