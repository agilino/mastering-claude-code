...
// mode), short stack, mostly-empty/green context bar. Both columns share
// the same fixed stack height so bars and captions line up.
const careless = [
  'grep -r "notif" app/',
  'read 40 files',
  ...
  <div class="w-full grid grid-cols-2 gap-8 items-end">
    ...
    <div class="flex flex-col items-center gap-2">
      ...
      <div v-click="11" class="w-full rounded overflow-hidden flex" style="border: 1px solid var(--na-zinc-700)">
        <div class="h-5" style="width: 18%; background: var(--na-success-500)" />
        <div class="h-5 flex-1" style="background: var(--na-zinc-900)" />
      </div>
      <div v-click="11" class="text-sm" style="color: var(--na-success-500)">context: ~18% consumed</div>
    </div>
