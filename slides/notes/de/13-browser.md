...
- VOLLSTÄNDIGE LÖSUNG (nur für Trainer; sollte beim Setup schon erledigt sein):
  ...
  claude mcp list
- Sagen: Die Registrierung ist meist ein einmaliger Terminal-Befehl — im Projekt-Scope geht es auch über eine `.mcp.json`-Datei, die man selbst bearbeitet und committet
...
- Den Vorteil qualitativ benennen: kompakte Snapshots gegenüber den Tool-Schemas eines MCP-Servers plus DOM — Tool Search verzögert das volle Laden der Schemas standardmäßig
