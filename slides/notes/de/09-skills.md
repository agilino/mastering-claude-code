...
- Sagen: "Auch hier startest du nicht bei null. CLASH bringt neun mitgelieferte Skills mit. Wir fügen einen eigenen hinzu."
...
- [click] Verweis zurück auf /skill-doctor: genau das misst es — wie viele Beschreibungen du bezahlst gegenüber wie viele Bodies überhaupt geladen werden

<!-- @note: commands-became-skills-nothing-broke -->
- Ein verbreitetes Missverständnis korrigieren: dass Commands in Skills aufgehen, macht .claude/commands/*.md-Dateien nicht kaputt
...
- Beim Server-Action-Schritt anhalten und erklären: er besteht auf einem eigenen Ownership-Check, obwohl requireUser() im Layout läuft
...
- Nur vorausdeuten
- [click] Sagen: "Ein Skill ist das, was du einem neuen Kollegen erzählen würdest. Es ist ein Ratschlag, kein Gesetz."

<!-- @note: ship-something-small-end-to-end -->
- Den Skill wirklich aufrufen: "/clash-feature Add venue favourites: a user can favourite a venue from its detail page and see a list of their favourites on their profile."
- Laufen lassen
