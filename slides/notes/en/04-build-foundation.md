<!-- @note: build-clash -->
- Divider for Part II.
- Say: "From here on you build. I show one step, you do it on your
...
- Contrast with the cold prompt "set up a Next.js app": it works too, but nobody — not you, not Claude — knows when it's finished.
...
- Type the rules live, one by one — say why each is there:
  - SQLite has no enums
...
<!-- @note: foundation -->
- Task 02 recap.
- Say the reset branch and where the task file is: 02-start = spec plus a first CLAUDE.md; 03-start = where you land if this task goes wrong.
...
- Say: "answer yes to everything you are not sure about."
