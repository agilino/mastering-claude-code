...
- [click] Show: the brief from Task 05 — each job has its own paths
- [click:4] Say: the paths are what keep the jobs apart
...
- Point: know the price of the way you work, then decide
...
- Say clearly: your build stays on your branch; the next parts need one shared codebase, so everyone moves to the reference
