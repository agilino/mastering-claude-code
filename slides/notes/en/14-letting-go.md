...
- Give it time
- Mention without demoing: `isolation: worktree` in a subagent's frontmatter, and the EnterWorktree/ExitWorktree tools
...
- Point at the three controls: allowedTools (auto-approves, does not restrict) + disallowedTools (actually blocks), hooks.PreToolUse, maxTurns
