...
- Say: this is undo for the conversation — it does not replace git
...
- [click:4] Say: the tool results band is the files Claude read — it keeps growing. When the window is almost full, Claude Code clears older tool outputs first, then compacts
...
- Say the sentence the group must keep: a Server Action is a public endpoint with a generated id
...
- Say out loud: this is the longest task of the part, and finishing "Now you" is optional
